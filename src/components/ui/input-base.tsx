...
function InputBaseInput({ className, ...props }: React.ComponentProps<typeof Primitive.input>) {
  return (
    <Primitive.input
      ...
      className={cn(
        'placeholder:text-muted-foreground file:text-foreground w-full flex-1 truncate bg-transparent file:border-0 file:bg-transparent file:text-sm file:font-medium focus:outline-none disabled:pointer-events-none',
        className
      )}
      {...props}
    />
