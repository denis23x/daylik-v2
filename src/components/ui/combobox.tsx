    ...
    <ComboboxPrimitive.Anchor asChild>
      <InputBase data-slot="combobox-input-base" {...props}>
        ...
        <ComboboxPrimitive.Clear asChild>
          <InputBaseAdornmentButton className="text-muted-foreground self-start">
            <XIcon />
          </InputBaseAdornmentButton>
  ...
  return (
    <ComboboxInputBase>
      <ComboboxPrimitive.TagGroup asChild>
        <InputBaseFlexWrapper data-slot="combobox-tags-input" className="flex items-center gap-2">
          {children}
          <InputBaseControl>
            <ComboboxPrimitive.Input asChild>
